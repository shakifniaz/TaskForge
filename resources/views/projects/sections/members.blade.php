    ...
    <x-projects.layout :project="$project" active="members">
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('projects.overview', $project) }}" class="text-sm underline text-gray-600 dark:text-gray-300">
                    Back to Overview
                </a>
            </div>
            ...
            <div class="p-6 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Current members</h3>
            ...
            {{-- Invite/Search --}}
            <div class="p-6 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Add new members</h3>
