        ...
        <div class="flex justify-center">
            <div class="w-full max-w-3xl space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold tf-h">Create Milestone</h1>
                        <p class="text-sm tf-sub">Add a milestone to the project roadmap</p>
                    </div>
                </div>
                ...
                <div class="rounded-3xl border border-black/10 bg-white shadow-sm p-6 tf-card tf-hovercard">
                    ...
                    <form method="POST"
                          action="{{ route('projects.roadmap.store', $project) }}"
